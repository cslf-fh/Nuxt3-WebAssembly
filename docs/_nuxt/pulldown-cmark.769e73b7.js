import{a as f,r as p,_ as g,k as v,b as c,w as m,l as b,e as n,v as w,m as y,o as h,p as _,q as k,s as x}from"./entry.8780e279.js";const $=r=>(_("data-v-1f1d9957"),r=r(),k(),r),T=$(()=>n("label",{for:"pre"},"preview only",-1)),I={class:"cmark"},M=["innerHTML"],C=f({__name:"pulldown-cmark",setup(r){const e="`",t="```",s=p(`# pulldown-cmark
...
`),i=p(),l=p(!1);let u;return g(()=>import("./pulldown_cmark.60f9a7ad.js"),["pulldown_cmark.60f9a7ad.js","__vite-plugin-wasm-helper.eadeccca.js"],import.meta.url).then(o=>u=o).finally(()=>{i.value=u?.pulldown_cmark(s.value)}),v(s,(o,a)=>{i.value=u?.pulldown_cmark(o)}),(o,a)=>(h(),c("div",null,[m(n("input",{"onUpdate:modelValue":a[0]||(a[0]=d=>l.value=d),id:"pre",type:"checkbox"},null,512),[[b,l.value]]),T,n("div",I,[l.value?y("",!0):m((h(),c("textarea",{key:0,"onUpdate:modelValue":a[1]||(a[1]=d=>s.value=d),class:"cmark__textarea"},null,512)),[[w,s.value]]),n("div",{innerHTML:i.value,class:"cmark__markdown"},null,8,M)])]))}});const E=x(C,[["__scopeId","data-v-1f1d9957"]]);export{E as default};
